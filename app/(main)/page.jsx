        ...
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ffaf7b] via-[#ffc3a0] to-[#ff9a9e] opacity-40 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
          ...
          <h1 className="font-heading text-3xl font-bold sm:text-5xl md:text-6xl lg:text-6xl">
            Empower Your Future by Learning Today.
          </h1>
